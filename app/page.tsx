...
export default function Home() {
  ...
  const [demoPhase, setDemoPhase] = useState<'idle' | 'cursor-moving' | 'cursor-click' | 'loading' | 'image' | 'caption' | 'hashtags' | 'hold'>('idle');
  ...
  const fullCaption = "Start your week right! Nothing beats Monday morning at your neighborhood spot.";
  const fullHashtags = "#LocalBusiness #CoffeeShop #SmallBizLove #CommunityFirst #ShopLocal";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Stop spending hours on social media content. Generate stunning branded posts, engaging captions, and perfect hashtags in seconds with the power of AI.
            </p>
          ...
          >
            ...
            <div
              style={{
                ...
                width: "120%",
                height: "120%",
                background: "radial-gradient(circle, rgba(44, 107, 237, 0.15) 0%, transparent 60%)",
                pointerEvents: "none",
              }}
            />
            ...
            <div
              style={{
                ...
                boxShadow: "0 30px 80px rgba(0,0,0,0.6), 0 0 60px rgba(44, 107, 237, 0.15)",
                maxWidth: 360,
                margin: "0 auto",
                position: "relative",
                overflow: "visible",
            ...
            >
              ...
              >
                {/* Placeholder state */}
                {(demoPhase === 'idle' || demoPhase === 'cursor-moving' || demoPhase === 'cursor-click') && (
                  <div
                    style={{
                      position: "absolute",
                      inset: 0,
                  ...
                  >
                    <svg width="56" height="56" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" viewBox="0 0 24 24">
                      <rect x="3" y="3" width="18" height="18" rx="2" />
                      <circle cx="8.5" cy="8.5" r="1.5" />
                      <path d="M21 15l-5-5L5 21" />
                    </svg>
                    <span style={{ fontSize: 12, opacity: 0.4 }}>Your image here</span>
                  </div>
                )}
                ...
                {(demoPhase === 'image' || demoPhase === 'caption' || demoPhase === 'hashtags' || demoPhase === 'hold') && (
                  <div
                    style={{
                      position: "absolute",
                      inset: 0,
              ...
              <div style={{ marginBottom: 12, minHeight: 60 }}>
                {(demoPhase === 'caption' || demoPhase === 'hashtags' || demoPhase === 'hold') && (
                  <div
                    style={{
                      fontSize: 13,
                      lineHeight: 1.5,
                  ...
                  >
                    {demoCaption}
                    {demoPhase === 'caption' && demoCaption.length < fullCaption.length && (
                      <span
                        style={{
              ...
              <div style={{ minHeight: 40 }}>
                {(demoPhase === 'hashtags' || demoPhase === 'hold') && (
                  ...
                  >
                    {demoHashtags}
                    {demoPhase === 'hashtags' && demoHashtags.length < fullHashtags.length && (
                      <span
                        style={{
                          display: "inline-block",
                          width: 2,
              ...
              <button
                ...
                style={{
                  width: "100%",
                  marginTop: 20,
                  background: demoPhase === 'cursor-click'
                  ...
                  transform: demoPhase === 'cursor-click' ? "scale(0.97)" : "scale(1)",
                  boxShadow: demoPhase === 'cursor-click'
              ...
              {(demoPhase === 'idle' || demoPhase === 'cursor-moving' || demoPhase === 'cursor-click') && (
                <div
                  style={{
                    ...
                    pointerEvents: "none",
                    zIndex: 20,
                    transition: demoPhase === 'idle' ? "none" : "left 1s cubic-bezier(0.4, 0, 0.2, 1), top 1s cubic-bezier(0.4, 0, 0.2, 1), transform 0.15s ease",
                    transform: demoPhase === 'cursor-click' ? "scale(0.8)" : "scale(1)",
      ...
      <section
        style={{
          background: "linear-gradient(180deg, rgba(44, 107, 237, 0.05) 0%, transparent 100%)",
          padding: "80px 40px",
        }}
      >
        <div
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            <p style={{ fontSize: 16, opacity: 0.7, maxWidth: 600, margin: "0 auto" }}>
              Create professional content that converts, without the professional price tag
            </p>
          </div>
      ...
      >
        <div
          style={{
            maxWidth: 800,
            margin: "0 auto",
            background: "linear-gradient(135deg, rgba(44, 107, 237, 0.15) 0%, rgba(124, 58, 237, 0.1) 100%)",
        ...
        >
          ...
          <div
            style={{
              ...
              width: "80%",
              height: "2px",
              background: "linear-gradient(90deg, transparent, #2c6bed, transparent)",
            }}
          />
