...
export default function GenerateVideoPage() {
  ...
  const primaryColor = activeProfile?.primaryColor ?? "#10b981";
  const secondaryColor = activeProfile?.secondaryColor ?? "#059669";

  return (
    <div style={{ minHeight: "100vh", background: "#0b1220", color: "#fff", fontFamily: "system-ui, sans-serif" }}>
      {/* Header */}
      <div style={{ background: "#101a33", borderBottom: "1px solid rgba(255,255,255,0.08)", padding: "14px 20px", display: "flex", alignItems: "center", gap: 14 }}>
        <button
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#7eb3ff" }}>Powered by Luma Dream Machine · 5 seconds · 2 tokens</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "28px 20px 60px" }}>
        ...
        {activeProfile && (
          <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: "12px 16px", marginBottom: 24, display: "flex", alignItems: "center", gap: 12 }}>
            ...
            {FORMAT_OPTIONS.map((opt) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: selected ? `linear-gradient(135deg, ${primaryColor}22, ${primaryColor}11)` : "rgba(255,255,255,0.04)",
                    border: selected ? `2px solid ${primaryColor}` : "1px solid rgba(255,255,255,0.1)",
                    borderRadius: 12,
                    padding: "14px 10px",
                    cursor: "pointer",
                ...
                >
                  {opt.recommended && (
                    <div style={{ position: "absolute" as const, top: 6, right: 8, fontSize: 9, fontWeight: 700, color: primaryColor, textTransform: "uppercase" as const, letterSpacing: "0.05em" }}>
                      Best
                    </div>
                  )}
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <textarea
            ...
            placeholder={
              activeProfile?.niche
                ? `e.g. A ${activeProfile.niche} professional reviewing a new listing, capturing attention in 5 seconds…`
                : "e.g. A business owner closing a deal, modern office, confident energy…"
            }
            rows={4}
            style={{
              width: "100%",
        ...
        {videoState === "generating" && (
          <div style={{ textAlign: "center" as const, padding: "40px 20px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, marginBottom: 24 }}>
            <div style={{ fontSize: 36, marginBottom: 16, animation: "spin 2s linear infinite" }}>🎬</div>
            <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 8 }}>Luma is generating your video…</div>
            <div style={{ color: "#7eb3ff", fontSize: 13, marginBottom: 20 }}>This usually takes 1–2 minutes. Hang tight.</div>
        ...
        {videoState === "completed" && videoUrl && (
          <div style={{ marginBottom: 24 }}>
            <div style={{ borderRadius: 16, overflow: "hidden", background: "#000", marginBottom: 16, border: "1px solid rgba(255,255,255,0.1)" }}>
              <video
                src={videoUrl}
                autoPlay
                loop
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 10,
                  color: savedToLibrary ? "#6ee7b7" : "#fff",
                  padding: "13px 16px",
                  fontSize: 13,
                  fontWeight: 600,
        ...
        {/* No social accounts connected notice */}
        {videoState === "completed" && !instagram.connected && !facebook.connected && (
          <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 10, padding: "12px 16px", fontSize: 13, color: "#aab4cc" }}>
            ...
            <button onClick={() => router.push("/dashboard")} style={{ background: "none", border: "none", color: "#7eb3ff", cursor: "pointer", padding: 0, fontSize: 13 }}>
              dashboard
            </button>{" "}
            to post directly.
          </div>
